...
wavelength = 0.1  # Wavelength of the EM wave
...
# Define the circular object and the metamaterial ring (cloaking device)
object_radius = 0.3
cloak_radius_outer = 0.5  # Outer radius of the cloaking device
cloak_radius_inner = 0.4  # Inner radius of the cloaking device

# Define the object and cloaking device on the grid
r = np.sqrt(X**2 + Y**2)
